...
class EditDishIngrView extends StatefulWidget {
  String dishCatg;
  ...
  EditDishIngrView();
  EditDishIngrView.withDishInfo({
    @required this.dishPic,
    @required this.dishName,
    @required this.dishPrice,
    @required this.totalPrepTime,
    @required this.dishCatg,
    @required this.dishAttr,
    @required this.passedDish,
  });

  @override
  _EditDishIngrViewState createState() => _EditDishIngrViewState();
}

class _EditDishIngrViewState extends State<EditDishIngrView> {
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: currentIngrList != null
                        ...
                        : widget.passedDish != null
                            ? ListView.builder(
                                shrinkWrap: true,
                                itemCount:
                                    widget.passedDish.dishIngrNames.length,
                                itemBuilder: (context, index) {
                                  return Container(
                                    margin: EdgeInsets.all(5),
                                    child: StandardText1(
                                        passedDescText: widget
                                            .passedDish.dishIngrNames[index]),
                                  );
                                },
                              )
                            : Center(
                                child: Text("Select ingredients to proceed")),
                  ),
