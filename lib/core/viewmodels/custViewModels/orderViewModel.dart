...
class OrderViewModel extends BaseViewModel {
  ...
  Future<String> createOrder(
    ...
    //
    List<double> nutritientslist = calculateEatenNutritients(items, allDishes);
    ...
    print(
        '------------------- eaten calories ' + nutritientslist[0].toString());
    Map<String, dynamic> planData = {};
    planData.addAll(
        {"custEatenKcal": (nutritientslist[0] + custPlan.custEatenKcal)});
    planData.addAll(
      {
        "custEatenProtein": (nutritientslist[1] + custPlan.custEatenProtein),
      },
    );
    planData.addAll(
      {
